...
| `model/step6_train/phase1_stand/harness/` | Phase 1 standing context, contracts, feedback loop, and update rules. |
...
### Phase 1 Standing Harness

`model/step6_train/phase1_stand/harness/` records the standing phase context,
contracts, feedback loop, and entropy policy. Every conversation or change that
updates Phase 1 standing behavior, commands, harness rules, contracts, scripts,
tests, or run instructions must update the relevant README in the same change.
